...
$(function() {
   ...
   //$("select").not('select[style="display: none;"]').formSelect();
   ...
   if($('a.dropdown-settings').length)
      $(".dropdown-settings").dropdown(configDropDown);

   $(".notification-button, .profile-button, .translation-button, .dropdown-menu").dropdown(configDropDown);
